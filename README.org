...
** Tratamento dos dados
   ...
   ## dat %>%
   ##   filter( !V003 == 'Não' & is.na(VALIDA) ) %>%
   ##   select( V002, V003, V004, V004_idade, V010, VALIDA) %>%
   ##   View

   ## dat %>%
   ##   filter( V003 == 'Sim' & !is.na(V002) & is.na(VALIDA) ) %>%
   ##   select( V002, V003, V004, V004_idade, V010, VALIDA) %>%
   ##   View

   ## dat %>%
   ##   filter( (!V003 == 'Sim' | is.na(V002) ) & V010_rmc == TRUE & V004_idade >= 18) %>%
   ##   select( V002, V003, V004, V004_idade, V010, V019, V022, VALIDA) %>%
   ##   View

   ## dat %>%
   ##   filter( (!V003 == 'Sim' | is.na(V002) ) & V010_rmc == TRUE & V004_idade >= 18) %>%
   ##   select( V002, V003, V004_idade, V010, V019, V022) %>%
   ##   View
