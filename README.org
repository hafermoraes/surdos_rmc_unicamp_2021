...
** Ambiente de computação
   ...
   loaded via a namespace (and not attached):
	[1] pillar_1.6.0     compiler_3.6.3   forcats_0.5.1    tools_3.6.3     
	[5] digest_0.6.27    lifecycle_1.0.0  tibble_3.1.1     gtable_0.3.0    
	[9] pkgconfig_2.0.3  rlang_0.4.11     DBI_1.1.1.9000   cli_2.4.0       
   [13] rstudioapi_0.13  withr_2.4.2      generics_0.1.0   vctrs_0.3.8     
   [17] hms_1.0.0        grid_3.6.3       tidyselect_1.1.0 glue_1.4.2      
   [21] R6_2.5.0         fansi_0.4.2      farver_2.1.0     purrr_0.3.4     
   [25] blob_1.2.1       magrittr_2.0.1   scales_1.1.1     ps_1.6.0        
   [29] ellipsis_0.3.2   assertthat_0.2.1 colorspace_2.0-0 labeling_0.4.2  
...
** Perfil dos participantes
   ...
   Até o momento src_R[:session :results replace ]{ nrow(dat)} {{{results(=239=)}}}  pessoas participaram da pesquisa, provenientes das seguintes cidades
   ...
   Dos quais até o momento src_R[:session :results replace ]{ nrow(dat %>% filter( !is.na(VALIDA)))} {{{results(=209=)}}}  participantes pertencem ao público alvo da pesquisa, provenientes das seguintes cidades
   ...
   - idade média de src_R[:session :results replace ]{ round( v004,1) } {{{results(=48.8=)}}} anos
   - src_R[:session :results replace ]{ round( v005[1,3]*100,1) } {{{results(=55=)}}} % do sexo src_R[:session :results replace ]{ v005[1,1] } {{{results(=Feminino=)}}}
   - src_R[:session :results replace ]{ 100*sum( v006[ c(4,5), 'p'] ) } {{{results(=42.1=)}}} % com ensino superior ou pós-graduação
   - src_R[:session :results replace ]{ 100*sum( v015[ c(1,2), 'p'] ) } {{{results(=74.2=)}}} % avaliam seu estado de saúde como bom ou muito bom
