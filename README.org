...
** Ambiente de computação
   ...
   loaded via a namespace (and not attached):
	...
	[9] fansi_0.4.2      blob_1.2.1       tools_3.6.3      grid_3.6.3      
   [13] gtable_0.3.0     utf8_1.2.1       cli_2.4.0        DBI_1.1.1.9000  
   [17] withr_2.4.2      ellipsis_0.3.2   assertthat_0.2.1 tibble_3.1.1    
   [21] lifecycle_1.0.0  crayon_1.4.1     purrr_0.3.4      ps_1.6.0        
   [25] vctrs_0.3.8      glue_1.4.2       stringi_1.5.3    compiler_3.6.3  
   [29] pillar_1.6.0     forcats_0.5.1    generics_0.1.0   scales_1.1.1    
   [33] pkgconfig_2.0.3
   #+end_example
...
** Perfil dos participantes
   ...
   Dos quais até o momento src_R[:session :results replace ]{ nrow(dat %>% filter( VALIDA == TRUE ))} {{{results(=209=)}}}  participantes pertencem ao público alvo da pesquisa, provenientes das seguintes cidades
