...
** Perfil dos participantes
   ...
   Até o momento src_R[:session :results replace ]{ nrow(dat)} {{{results(=219=)}}}  pessoas participaram da pesquisa, provenientes das seguintes cidades
   ...
   | CAPIVARI               |   1 | 0.005 |
   | COSMOPOLIS             |   1 | 0.005 |
   | GOIANIA GOIAS          |   1 | 0.005 |
   | HORTOLANDIA            |   1 | 0.005 |
   | HORTOLANDIA E CAMPINAS |   1 | 0.005 |
   | IRACEMAPOLIS           |   1 | 0.005 |
   | JUNDIAI                |   1 | 0.005 |
   | LIMEIRA                |   1 | 0.005 |
   | MEDINA MG              |   1 | 0.005 |
   | OSASCO                 |   1 | 0.005 |
   | POCOS DE CALDAS        |   1 | 0.005 |
   | SALTO                  |   1 | 0.005 |
   | SAO JOSE DO RIO PARDO  |   1 | 0.005 |
   | SAO PAULO S            |   1 | 0.005 |
   | SAO VICENTE            |   1 | 0.005 |
   | RESPOSTAS              | 219 |     1 |

   Dos quais até o momento src_R[:session :results replace ]{ nrow(dat %>% filter( !is.na(VALIDA)))} {{{results(=185=)}}}  participantes pertencem ao público alvo da pesquisa, provenientes das seguintes cidades
   ...
   - src_R[:session :results replace ]{ round( v005[1,3]*100,1) } {{{results(=54.1=)}}} % do sexo src_R[:session :results replace ]{ v005[1,1] } {{{results(=Feminino=)}}}
   - src_R[:session :results replace ]{ 100*sum( v006[ c(4,5), 'p'] ) } {{{results(=45.4=)}}} % com ensino superior ou pós-graduação
   - src_R[:session :results replace ]{ 100*sum( v015[ c(1,2), 'p'] ) } {{{results(=76.7=)}}} % avaliam seu estado de saúde como bom ou muito bom
