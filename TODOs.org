...
* Análise estatítica
  ...
  - [X] mencionar viés da nossa pesquisa e usar o argumento que se mesmo pros muito educados imagina para o publico conhecido da pesquisa
  - [X] incluir seções no README.org com as análises simples baseadas nas hipóteses de pesquisa
  ...
  - [100%] comparar situação de emprego por
	- [X] sexo
	- [X] faixa etária
	- [X] escolaridade
	- [X] raça
